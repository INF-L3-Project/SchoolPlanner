# Generated by Django 3.2.13 on 2022-06-02 03:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('abr', models.CharField(blank=True, max_length=50, null=True)),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.institution')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('TP', 'TP'), ('TD', 'TD'), ('Cours', 'Cours')], default='Cours', max_length=10)),
                ('grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.grade')),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.institution')),
            ],
        ),
