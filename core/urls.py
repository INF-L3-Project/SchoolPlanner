...
from core.views import HomeView, LoginView, SignupView, AccountView, BranchView, ClasseView, ClassroomView, CourseView, LevelView, TeacherView, UnitView, TimetableView, NotFoundView
